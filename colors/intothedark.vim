" Into The Dark
" MODIFIED VERSION OF ZENBURN
" Vim color file
"
" Original Copyright
" Maintainer:   Jani Nurminen <slinky@iki.fi>
" Last Change:  $Id: intothedark.vim,v 2.21 2011/04/26 12:13:41 slinky Exp slinky $
...
"
" After installation, use it with :colorscheme intothedark.
" See also :help syntax
"
" Credits:
"  - Jani Nurminen - original intothedark, maintainer
...
"  - Marcin Szamotulski - support autocomplete for intothedark configuration
"                         parameters
"  - Clayton Parker (claytron) - Convinced by Kurt Maier to use intothedark. Point
...
" set some parameters to tweak the intothedark colours.
"
" To use them, put them into your .vimrc file before loading the color scheme,
" example:
"    let g:intothedark_high_Contrast=1
"    colors intothedark
"
" You can also do ":let g:intothedark" then hit Ctrl-d or Tab to scroll through the
" list of configurable parameters.
"
" * You can now set a darker background for bright environments. To activate, use:
"   contrast intothedark, use:
"
"      let g:intothedark_high_Contrast = 1
"
...
"   look strange.
"
"      let g:intothedark_color_also_Ignore = 1
"
" * To get more contrast to the Visual selection, use
"
"      let g:intothedark_alternate_Visual = 1
"
"   Note: this is enabled only if the old-style Visual
"   if used, see g:intothedark_old_Visual
"
" * To use alternate colouring for Error message, use
"
"      let g:intothedark_alternate_Error = 1
"
" * The new default for Include is a duller orange. To use the original
"   colouring for Include, use
"
"      let g:intothedark_alternate_Include = 1
"
" * Work-around to a Vim bug, it seems to misinterpret ctermfg and 234 and 237
"   as light values, and sets background to light for some people. If you have
"   this problem, use:
"
"      let g:intothedark_force_dark_Background = 1
"
...
"
"      let g:intothedark_unified_CursorColumn = 1
"
...
"
"      let g:intothedark_old_Visual = 1
"
"   Default is to use the new Visual.
"
"  * EXPERIMENTAL FEATURE: intothedark will automatically detect if you 
...
"
"    let g:intothedark_disable_ctags_highlighting_support = 1
"
" NOTE:
"
" * To turn the parameter(s) back to defaults, use UNLET or set them to 0:
"
"      unlet g:intothedark_alternate_Include
"   or 
"      let g:intothedark_alternate_Include = 0
"
"
" That's it, enjoy!
"
...
if ! exists("g:intothedark_high_Contrast")
    let g:intothedark_high_Contrast = 0
endif

if ! exists("g:intothedark_color_also_Ignore")
    let g:intothedark_color_also_Ignore = 0
endif

if ! exists("g:intothedark_alternate_Error")
    let g:intothedark_alternate_Error = 0
endif

if ! exists("g:intothedark_force_dark_Background")
    let g:intothedark_force_dark_Background = 0
endif

if ! exists("g:intothedark_alternate_Visual")
    let g:intothedark_alternate_Visual = 0
endif

if ! exists("g:intothedark_alternate_Include")
    let g:intothedark_alternate_Include = 0
endif

if ! exists("g:intothedark_unified_CursorColumn")
    let g:intothedark_unified_CursorColumn = 0
endif

if ! exists("g:intothedark_old_Visual")
    let g:intothedark_old_Visual = 0
endif

if ! exists("g:intothedark_disable_ctags_highlighting_support")
    " enabled by default
    let g:intothedark_disable_ctags_highlighting_support = 0
endif
...
let g:colors_name="intothedark"

" check for ctags-highlighting
if exists("g:loaded_ctags_highlighting") && g:loaded_ctags_highlighting && ! g:intothedark_disable_ctags_highlighting_support
    " internal
    let _intothedark_ctags = 1
endif
...
if &t_Co > 255
    ...
    if exists("g:intothedark_high_Contrast") && g:intothedark_high_Contrast
        hi Normal ctermfg=188 ctermbg=234
        hi NonText         ctermfg=238

        if exists("g:intothedark_color_also_Ignore") && g:intothedark_color_also_Ignore
        ...
        if exists("g:intothedark_unified_CursorColumn") && g:intothedark_unified_CursorColumn
    ...
    if exists("g:intothedark_alternate_Error") && g:intothedark_alternate_Error
        " use more jumpy Error
        hi Error ctermfg=210 ctermbg=52 gui=bold
    else
        " default is something more intothedark-compatible
        hi Error ctermfg=228 ctermbg=95 gui=bold
    endif
endif

if exists("g:intothedark_force_dark_Background") && g:intothedark_force_dark_Background
...
hi CursorLine      guibg=#2a2a2a gui=bold
if exists("g:intothedark_unified_CursorColumn") && g:intothedark_unified_CursorColumn
    hi CursorColumn    guibg=#2a2a2a gui=bold
else
    hi CursorColumn    guibg=#2b2b2b
endif
hi Pmenu           guibg=#000000 guifg=#ccccbc
...
hi Visual        guibg=#6f6f6f
hi VisualNos     guibg=#6f6f6f
if &t_Co > 255
    hi Visual ctermbg=0
endif
...
if exists("g:intothedark_alternate_Include") && g:intothedark_alternate_Include
    " original setting
...
"
" For now I mostly link to subset of intothedark colors, the linkage is based
" on appearance, not semantics. In later versions I might define more new colours.
"
" HELP NEEDED to make this work properly.
if exists("_intothedark_ctags") && _intothedark_ctags
